...
const Body = () => {
  return (
    ...
    <RestaurantCard  card={restaurantList[0].data} />
    <RestaurantCard  card={restaurantList[1].data} />
    <RestaurantCard card={restaurantList[2].data}  />
    <RestaurantCard card={restaurantList[3].data}  />
    <RestaurantCard card={restaurantList[4].data} />
    <RestaurantCard card={restaurantList[5].data} />
    <RestaurantCard card={restaurantList[6].data} />
    <RestaurantCard card={restaurantList[7].data} />
    <RestaurantCard card={restaurantList[8].data} />
    <RestaurantCard card={restaurantList[9].data} />
    <RestaurantCard card={restaurantList[10].data} />
    <RestaurantCard card={restaurantList[11].data} />
    <RestaurantCard card={restaurantList[12].data} />
    <RestaurantCard card={restaurantList[13].data} />
    <RestaurantCard card={restaurantList[14].data} />
